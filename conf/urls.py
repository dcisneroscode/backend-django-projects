...
from management_app.views import StudentDetailtView, StudentUpdateView, StudentListView, StudentCreateView, StudentDeleteView 

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', StudentListView.as_view(), name='student-list'),
    path('<int:pk>/',StudentDetailtView.as_view(), name='student-detail'),
